...
Solution:
  ...
  */}
  ...
  <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 sm:p-6 lg:p-8 rounded-2xl max-w-md w-full shadow-2xl relative overflow-hidden h-auto max-h-[90vh] overflow-y-auto flex flex-col">
    ...
    <p className="text-zinc-500 dark:text-zinc-400 text-xs sm:text-sm mb-4 sm:mb-6 font-mono tracking-wide transition-colors duration-700 flex-shrink-0">
    ...
    <div className="mt-auto sticky bottom-0 pt-3 bg-white dark:bg-zinc-900">
      <button
        ...
        className="cursor-target w-full py-3 sm:py-4 bg-zinc-900 dark:bg-white text-white dark:text-black font-black tracking-widest uppercase text-sm rounded-xl hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors flex items-center justify-center gap-2 group"
      >
        Enter Portfolio
