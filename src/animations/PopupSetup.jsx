...
export const PopupSetup = ({ theme, setTheme, musicPlaying, toggleMusicPreference, startPortfolio, audioRef, currentTrack, nextTrack, prevTrack }) => {
  return (
    <div className="fixed inset-0 z-[90] bg-zinc-100/80 dark:bg-zinc-950/80 backdrop-blur-xl flex items-center justify-center p-2 transition-colors duration-700">
      
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 px-5 py-4 sm:p-8 rounded-2xl max-w-md w-full shadow-2xl transform transition-all animate-in fade-in zoom-in duration-700 ease-[cubic-bezier(0.85,0,0.15,1)] relative overflow-hidden max-h-[96vh] overflow-y-auto flex flex-col">
        ...
        <h2 className="text-2xl sm:text-3xl font-black tracking-tighter mb-0.5 text-zinc-900 dark:text-white transition-colors duration-700 flex-shrink-0">
          SYSTEM SETUP
        </h2>
        
        <p className="text-zinc-500 dark:text-zinc-400 text-xs sm:text-sm mb-2 sm:mb-6 font-mono tracking-wide transition-colors duration-700 flex-shrink-0">
          Configure your viewing experience.
        </p>
        
        <div className="space-y-2 sm:space-y-4 mb-2 sm:mb-6 flex-shrink-0">
