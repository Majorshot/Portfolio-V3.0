...
export const PopupSetup = ({ theme, setTheme, musicPlaying, toggleMusicPreference, startPortfolio, audioRef, currentTrack, nextTrack, prevTrack }) => {
  return (
    <div className="fixed inset-0 z-[90] bg-zinc-100/80 dark:bg-zinc-950/80 backdrop-blur-xl flex items-center justify-center p-4 transition-colors duration-700">
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 rounded-2xl max-w-md w-full shadow-2xl transform transition-all animate-in fade-in zoom-in duration-700 ease-[cubic-bezier(0.85,0,0.15,1)] relative overflow-hidden">
        ...
        <h2 className="text-3xl font-black tracking-tighter mb-2 text-zinc-900 dark:text-white transition-colors duration-700">SYSTEM SETUP</h2>
        <p className="text-zinc-500 dark:text-zinc-400 text-sm mb-8 font-mono tracking-wide transition-colors duration-700">Configure your viewing experience.</p>
        
        <div className="space-y-4 mb-8">
          <div className="flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-200/50 dark:border-zinc-800/50 transition-colors duration-700">
        ...
        <button onClick={startPortfolio} className="cursor-target w-full py-4 bg-zinc-900 dark:bg-white text-white dark:text-black font-black tracking-widest uppercase text-sm rounded-xl hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors flex items-center justify-center gap-2 group">
          Enter Portfolio
