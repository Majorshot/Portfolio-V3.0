...
export const PopupSetup = ({ theme, setTheme, musicPlaying, toggleMusicPreference, startPortfolio, audioRef, currentTrack, nextTrack, prevTrack }) => {
  return (
    <div className="fixed inset-0 z-[90] bg-zinc-100/80 dark:bg-zinc-950/80 backdrop-blur-xl flex items-center justify-center p-4 transition-colors duration-700">
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 sm:p-8 rounded-2xl max-w-md w-full shadow-2xl transform transition-all animate-in fade-in zoom-in duration-700 ease-[cubic-bezier(0.85,0,0.15,1)] relative overflow-hidden max-h-[92vh] overflow-y-auto flex flex-col">
        ...
        <div className="space-y-2 sm:space-y-4 mb-3 sm:mb-6 flex-shrink-0">
          ...
          <div className="flex flex-col items-center justify-center p-0 sm:p-1 rounded-xl">
            <MediaPlayer 
              audioRef={audioRef}
