...
export const Marquee = ({ theme }) => {
  return (
    <section className="relative w-full overflow-hidden border-y border-zinc-200 dark:border-zinc-800 py-6 bg-zinc-100/80 dark:bg-zinc-900/80 backdrop-blur-xl z-20">
